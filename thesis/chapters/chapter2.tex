...
% TODO riempire la tabella percentuali sul rilevante
...
\begin{figure}[ht]
	...
	\end{subfigure}
	\caption{Visual representation of Table \ref{table:annotations-distribution}} % caption for whole figure
