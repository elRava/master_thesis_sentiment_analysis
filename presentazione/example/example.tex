...
\begin{document}
	...
	\begin{frame}{Dataset Statistics}
		...
		\only<1>{
			\begin{figure}
				\centering
				\vspace{-5mm}
				\includegraphics[width=\linewidth]{figures/annotations-distribution-perc.png}
			\end{figure}
		}
		\only<2>{
			\begin{figure}
				\centering
				\vspace{-5mm}
				\includegraphics[width=\linewidth]{figures/sentiment-distribution.png}
			\end{figure}
		}
	...
	\begin{frame}{Baseline Approach (2)}
	...
	\begin{frame}{My BPEF Implementation}
